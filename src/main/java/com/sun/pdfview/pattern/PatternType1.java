/*
 * $Id: PatternType1.java,v 1.4 2010-05-23 22:07:06 lujke Exp $
 *
...
public class PatternType1 extends PDFPattern {
    ...
    /**
     * Create a PDFPaint from this pattern and set of components. This creates a buffered image of this pattern using
     * the given paint, then uses that image to create the correct TexturePaint to use in the PDFPaint.
     *
     * @param basePaint
    ...
    /*public PDFPaint getPaint(PDFPaint basePaint) {
        ...
        // bounding box
        Rectangle2D anchor = new Rectangle2D.Double(getBBox().getMinX(), getBBox().getMinY(), getXStep(), getYStep());
        ...
        /*
         * AffineTransform xform = new AffineTransform(1, 0, 0, -1, 0, getYStep()); //new AffineTransform(1, 0, 0, -1,
         * 0, getBBox().getHeight()); page.addXform(xform);
         */
